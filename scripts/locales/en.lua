local lang = {
  ...
  ["flow_devices"] = {
    ["active_sflow"] = "Active sFlow Probes",
    ["all_device_ports"] = "All %{device} Ports",
    ["all_flow_devices"] = "All Flow Probes",
    ["all_probes"] = "All Probes",
    ["collection"] = "Collection",
    ["all_sflow_devices"] = "All sFlow Probes",
    ["duplex"] = "Duplex",
    ["enable_flow_ratio"] = "Enable Flow/SNMP Ratio",
    ["probe_ip"] = "Probe IP",
    ["probes"] = "Probes",
    ["flow_device_x"] = "Probe %{device}",
    ["flow_device_x_interface_y"] = "Probe %{device} / %{interface}",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_tls_cert_validity_too_long"] = "Too Long TLS Certificate Validity",
